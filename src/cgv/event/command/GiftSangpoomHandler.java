...
public class GiftSangpoomHandler implements CommandHandler{
...
//		request.setAttribute("giftCard", list);
		...
		ArrayList<Giftshop_mainDTO> list = service.sangpoomSelect();
		
		request.setAttribute("sangpoom", list);
		
		
		return "/cgv/event/cgv_giftshop_08";
	}
