	...
	<div id="container">
		...
		<div class="content">
			<div class="category_wrap">
	 			<div class="category_contents_wrap">
	     			<ul class="category_content" >
						...
						<li id="cm2" name="categorymenu" class="active"><a href="cgv_giftshop_01.do">영화관람권</a></li>
			...
			<div class="category_product_list_wrap">
				<strong class="category_product_list_title">영화관람권<span>영화, 모두에게 즐거운 경험</span></strong>
						...
						<li class="">
							<a href="cgv_giftshop_detail.do?giftcode=${ticket.gift_code }" class="btn_category_product">
								<span class="com_list_img_wrap">
									...
									<span class="com_list_text_title">${ticket.gift_name }</span> 
									<span class="com_list_text_name">${ticket.gift_detail }</span> 
									<span class="com_list_sale_price_wrap"> 
										<span class="store_deatail_source_price">${ticket.gift_payment }</span>
									</span>
								</span>
							</a> 
							<a href="cgv_giftshop_cart.do?giftcode=${ticket.gift_code}" class="btn_category_product_cart circle_btn"><span>장바<br>구니</span></a> 
							<a href="cgv_giftshop_cart.do?giftcode=${ticket.gift_code}" class="btn_category_product_cart circle_btn"><span>장바<br>구니</span></a> 
