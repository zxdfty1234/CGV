	...
	<div id="container">
		...
		<div class="content">
			<div class="category_wrap">
	 			<div class="category_contents_wrap">
	     			<ul class="category_content" >
						...
						<li id="cm4" name="categorymenu" class="active"><a href="cgv_giftshop_03.do">콤보</a></li>
			...
			<div class="category_product_list_wrap">
				<strong class="category_product_list_title">콤보<span>맛있으면 1600칼로리, 아는 맛이 제일 맛있어요</span></strong>
						...
						<li class="">
							<a href="cgv_giftshop_detail.do?giftcode=${combo.gift_code }" class="btn_category_product">
								<span class="com_list_img_wrap">
									...
									<img src="../${combo.gift_image }" alt="${combo.gift_name }">
								</span>
									<span class="com_list_text_wrap"> 
									<span class="com_list_text_title">${combo.gift_name }</span> 
									<span class="com_list_text_name">${combo.gift_detail }</span> 
									<span class="com_list_sale_price_wrap"> 
										<span class="store_deatail_source_price">${combo.gift_payment }</span>
									</span>
								</span>
							</a> 
							<a href="cgv_giftshop_cart.do?giftcode=${combo.gift_code}" class="btn_category_product_cart circle_btn"><span>장바<br>구니</span></a> 
							<a href="cgv_giftshop_cart.do?giftcode=${combo.gift_code}" class="btn_category_product_cart circle_btn"><span>장바<br>구니</span></a> 
