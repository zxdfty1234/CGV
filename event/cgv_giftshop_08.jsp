	...
	<div id="container">
		...
		<div class="content">
			<div class="category_wrap">
	 			<div class="category_contents_wrap">
	     			<ul class="category_content" >
						...
						<li class="active"><a href="cgv_giftshop_08.do">상품권소개</a></li>      
					</ul>
			...
			<div class="category_product_list_wrap">
				<strong class="category_product_list_title">상품권소개<span>마음을 담아 선물하세요.</span></strong>
				<ul class="com_list_style">
					<c:forEach var="sangpoom" items="${sangpoom }">
						<li class="">
							<a href="/culture-event/popcorn-store/product-detail.aspx?GG_NO=100253" class="btn_category_product">
								<span class="com_list_img_wrap">
									<img src="../${sangpoom.gift_image }" alt="${sangpoom.gift_name }">
								</span>
									<span class="com_list_text_wrap"> 
									<span class="com_list_text_title">${sangpoom.gift_name }</span> 
									<span class="com_list_text_name">${sangpoom.gift_content }</span> 
									<span class="com_list_sale_price_wrap"> 
										<span class="store_deatail_source_price"></span>
									</span>
								</span>
							</a> 
						</li>
