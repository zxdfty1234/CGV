	...
	<div id="container">
		...
		<div class="content">
			<div class="category_wrap">
	 			<div class="category_contents_wrap">
	     			<ul class="category_content" >
						...
						<li id="cm3" name="categorymenu" class="active"><a href="cgv_giftshop_02.do">기프트카드</a></li>
			...
			<div class="category_product_list_wrap">
				<strong class="category_product_list_title">기프트카드<span>센스있는 선물의 정석</span></strong>
						...
						<li class="">
							<a href="cgv_giftshop_detail.do?giftcode=${giftcard.gift_code }" class="btn_category_product">
								<span class="com_list_img_wrap">
									...
									<img src="../${giftcard.gift_image }" alt="${giftcard.gift_name }">
								</span>
									<span class="com_list_text_wrap"> 
									<span class="com_list_text_title">${giftcard.gift_name }</span> 
									<span class="com_list_text_name">${giftcard.gift_detail }</span> 
									<span class="com_list_sale_price_wrap"> 
										<span class="store_deatail_source_price">${giftcard.gift_content }</span>
									</span>
								</span>
							</a> 
