	...
	<div id="container">
		...
		<div class="content">
			<div class="category_wrap">
	 			<div class="category_contents_wrap">
	     			<ul class="category_content" >
						...
						<li id="cm5" name="categorymenu" class="active"><a href="cgv_giftshop_04.do">팝콘</a></li>
			...
			<div class="category_product_list_wrap">
				<strong class="category_product_list_title">팝콘<span>고소, 달콤부터 고메팝콘까지, 안먹으면 서운해요</span></strong>
				<ul class="com_list_style">
					<c:forEach var="popcorn" items="${popcorn }">
						<li class="">
							<a href="cgv_giftshop_detail.do?giftcode=${popcorn.gift_code }" class="btn_category_product">
								<span class="com_list_img_wrap">
									...
									<img src="../${popcorn.gift_image }" alt="${popcorn.gift_name }">
								</span>
									<span class="com_list_text_wrap"> 
									<span class="com_list_text_title">${popcorn.gift_name }</span> 
									<span class="com_list_text_name">${popcorn.gift_detail }</span> 
									<span class="com_list_sale_price_wrap"> 
										<span class="store_deatail_source_price">${popcorn.gift_payment }</span>
									</span>
								</span>
							</a> 
							<a href="cgv_giftshop_cart.do?giftcode=${popcorn.gift_code}" class="btn_category_product_cart circle_btn"><span>장바<br>구니</span></a> 
							<a href="cgv_giftshop_cart.do?giftcode=${popcorn.gift_code}" class="btn_category_product_cart circle_btn"><span>장바<br>구니</span></a> 
