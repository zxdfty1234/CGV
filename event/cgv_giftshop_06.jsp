	...
	<div id="container">
		...
		<div class="content">
			<div class="category_wrap">
	 			<div class="category_contents_wrap">
	     			<ul class="category_content" >
						...
						<li id="cm7" name="categorymenu" class="active"><a href="cgv_giftshop_06.do">스낵</a></li>
			...
			<div class="category_product_list_wrap">
				<strong class="category_product_list_title">스낵<span>출출할땐 다양한 스낵이 정답이죠</span></strong>
						...
						<li class="">
							<a href="cgv_giftshop_detail.do?giftcode=${snack.gift_code }" class="btn_category_product">
								<span class="com_list_img_wrap">
									...
									<img src="../${snack.gift_image }" alt="${snack.gift_name }">
								</span>
									<span class="com_list_text_wrap"> 
									<span class="com_list_text_title">${snack.gift_name }</span> 
									<span class="com_list_text_name">${snack.gift_detail }</span> 
									<span class="com_list_sale_price_wrap"> 
										<span class="store_deatail_source_price">${snack.gift_payment }</span>
									</span>
								</span>
							</a> 
							<a href="cgv_giftshop_cart.do?giftcode=${snack.gift_code}" class="btn_category_product_cart circle_btn"><span>장바<br>구니</span></a> 
							<a href="cgv_giftshop_cart.do?giftcode=${snack.gift_code}" class="btn_category_product_cart circle_btn"><span>장바<br>구니</span></a> 
