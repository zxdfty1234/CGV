	...
	<div id="container">
		...
		<div class="content">
			<div class="category_wrap">
	 			<div class="category_contents_wrap">
	     			<ul class="category_content" >
						...
						<li id="cm10" name="categorymenu" class="active"><a href="cgv_giftshop_07.do">플레이존</a></li>
			...
			<div class="category_product_list_wrap">
				<strong class="category_product_list_title">플레이존<span>마음을 담아 선물하세요.</span></strong>
				<ul class="com_list_style">
					<c:forEach var="playzone" items="${playzone }">
						<li class="">
							<a href="cgv_giftshop_detail.do?giftcode=${playzone.gift_code }" class="btn_category_product">
								<span class="com_list_img_wrap">
									<span class="com_list_box"></span>
									<img src="../${playzone.gift_image }" alt="${playzone.gift_name }">
								</span>
									<span class="com_list_text_wrap"> 
									<span class="com_list_text_title">${playzone.gift_name }</span> 
									<span class="com_list_text_name">${playzone.gift_detail }</span> 
									<span class="com_list_sale_price_wrap"> 
										<span class="store_deatail_source_price">${playzone.gift_payment }</span>
										<span class="store_deatail_sale_price"></span>
									</span>
								</span>
							</a> 
							<a href="cgv_giftshop_cart.do?giftcode=${playzone.gift_code}" class="btn_category_product_cart circle_btn"><span>장바<br>구니</span></a> 
							<a href="cgv_giftshop_cart.do?giftcode=${playzone.gift_code}" class="btn_category_product_cart circle_btn"><span>장바<br>구니</span></a> 
